        ...
        inquiries.map((inquiry) => (
          <article
            ...
            className="rounded-lg border border-zinc-200 bg-white p-4 shadow-sm
              group transition-shadow duration-150 ease-out hover:shadow-md
          ...
          >
            ...
            <p
              className="mt-2 text-sm leading-6 line-clamp-2 text-zinc-700 dark:text-zinc-300 
              transition-colors duration-150 ease-out group-hover:text-brand-600 dark:group-hover:text-brand-400
            "
            >
              {inquiry.title}
            </p>
